...
const arial = join(diretorioDeFontes, 'ARIAL.TTF');
const arialNegrito = join(diretorioDeFontes, 'ARIALBD.TTF');
const arialNegritoItalico = join(diretorioDeFontes, 'ARIALBI.TTF');
const arialItalico = join(diretorioDeFontes, 'ARIALI.TTF');
...
var GeradorDeBoleto = (function () {
  ...
  GeradorDeBoleto.prototype.gerarPDF = function (args) {
    return new Promise((resolve) => {
      ...
      if (args.systemInteract) {
        args.tamanhoDaLinhaDigitavel = 12;
      }
      ...
      const pagadorCpf = boletos[0].getPagador().getRegistroNacional();
      const passOptions = args.systemInteract
        ? {
            userPassword: String(pagadorCpf).slice(-4),
          }
        : {};
      const pdf = new Pdf({
      ...
      pdf.registerFont('normal', args.systemInteract ? arial : timesNewRoman);
      pdf.registerFont(
        'negrito',
        args.systemInteract ? arialNegrito : timesNewRomanNegrito
      );
      pdf.registerFont(
        'italico',
        args.systemInteract ? arialItalico : timesNewRomanItalico
      );
      pdf.registerFont(
        'negrito-italico',
        args.systemInteract
          ? arialNegritoItalico
          : timesNewRomanNegritoItalico
      );
      pdf.registerFont('codigoDeBarras', code25I);

      if (args.systemInteract) {
        const [boleto] = this._boletos;
        ...
        pdf.image(
          join(__dirname, 'imagens', 'system-interact.png'),
          args.ajusteX + 27,
          args.ajusteY + 121,
          {
            width: 70,
        ...
        pdf.image(
          join(__dirname, 'imagens', 'bradesco-logo.png'),
          514 - 27,
          args.ajusteY + 121,
          {
            width: 80,
        ...
        const marginImages = args.ajusteY + 121 + 70 + 50;

        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonte)
          .text(
            `Prezado (a): ${pagador.getNome()} - CPF: ${pagador.getRegistroNacionalFormatado()}`,
            args.ajusteX + 27,
            marginImages,
            {
              lineBreak: true,
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Conforme entendimento, segue abaixo detalhes da negociação realizada.',
            args.ajusteX + 27,
            null,
            {
              lineBreak: true,
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            ` Saldo total atualizado da(s) dívida(s) vencida(s): ${boleto.getValorFormatadoBRL()}`,
            args.ajusteX + 27,
            null,
            {
              lineBreak: false,
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            `Plano: ( ) Em ${args.systemInteract.qtdParcelas} parcela(s) de ${boleto.getValorFormatadoBRL()}`,
            args.ajusteX + 27,
            null,
            {
              lineBreak: false,
        ...
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonte)
          .text(`Vencimento: ${datas.getVencimentoFormatado()}`, args.ajusteX + 27, null, {
            lineBreak: false,
            //	width: 294,
            align: 'left',
          });
        ...
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonte)
          .text('CONTRATO(S) NEGOCIADO(S):', args.ajusteX + 27, null, {
            lineBreak: false,
            //	width: 294,
            align: 'left',
          });
        ...
        const products = args.systemInteract.produtos.split(' | ')
        
        products.forEach((p) => {
          pdf
            .font('normal')
            .fontSize(args.tamanhoDaFonte)
            .text(`${p} |`, args.ajusteX + 27, null, {
              lineBreak: true,
              //	width: 294,
              align: 'left',
            });
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Optando pela alternativa a seguir, ',
            args.ajusteX + 27,
            null,
            {
              continued: true,
          ...
          .font('negrito')
          .text(
            'já acrescidos de juros remuneratórios de 3.00%a.m. e IOF financiado.',
            {
              continued: true,
            }
          )
          .font('normal')
          .text(
            ', preencha o campo 6 (=) Valor Cobrado da ficha de compensação abaixo, com o valor da primeira parcela.'
          )
          .moveDown();
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Realize o pagamento através do internet banking ou imprima este boleto e pague em qualquer banco até a data de vencimento.',
            args.ajusteX + 27,
            null,
            {
              lineBreak: true,
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Caso constem dívidas de cartão de crédito nesta negociação, estão inclusos somente os cartões com forma de pagamento por meio de débito em conta corrente, desde que constante da relação de contratos.',
            args.ajusteX + 27,
            null,
            {
              lineBreak: true,
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Se esta negociação contiver parcelas futuras e caso não receber o carnê para pagamento das demais parcelas no endereço de cadastro no prazo de até 20(vinte) dias após o pagamento da primeira parcela, entre em contato com nossa central de atendimento.',
            args.ajusteX + 27,
            null,
            {
              lineBreak: true,
        ...
        pdf
          .font('negrito')
          .fontSize(args.tamanhoDaFonte)
          .text('Central de atendimento', args.ajusteX + 27, null, {
            align: 'left',
            underline: true,
          })
          .moveDown(0.2);
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Tel. 0800 727 5120 ou 11 96914 7384 WhatsApp',
            args.ajusteX + 27,
            null,
            {
              lineBreak: true,
          ...
          .text(
            'De Seg. a Sex. das 07:20h às 20:00h e aos Sábados das 09:00h às 15:20h',
            args.ajusteX + 27,
            null,
            {
              lineBreak: true,
          ...
          .text('(horário de Brasília).', args.ajusteX + 27, null, {
            lineBreak: true,
            align: 'left',
          });
      ...
      boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
        ...
        pdf
          ...
          .lineTo(
            ...
            args.ajusteY +
              (banco.exibirReciboDoPagadorCompleto() ? linha4Opcional : linha3)
          )
          .stroke(args.corDoLayout);
        ...
        pdf
          ...
          .lineTo(
            args.ajusteX + coluna4,
            args.ajusteY +
              (banco.exibirReciboDoPagadorCompleto() ? linha3 : linha2)
          )
          .stroke(args.corDoLayout);
        ...
        if (banco.exibirReciboDoPagadorCompleto()) {
          ...
          pdf
            ...
            .lineTo(
              args.ajusteX + coluna6Opcional,
              args.ajusteY + linha4Opcional + 0.5
            )
            .stroke(args.corDoLayout);
        ...
        var linha4 =
          (banco.exibirReciboDoPagadorCompleto() ? linha3 : linha2) + 4;
        pdf
        ...
        var margemDaLinhaSeparadora = 30,
          divisoresVerticais =
            (linha4Opcional || linha3) + 2 * margemDaLinhaSeparadora - 4,
        ...
        var linhaSeparadora =
          (linha4Opcional || linha3) + margemDaLinhaSeparadora;
        ...
        if (enderecoDoBeneficiario) {
          var zeroUmLinha =
              zeroLinha + 2 + args.tamanhoDaFonte + args.tamanhoDaFonte,
          ...
          if (enderecoDoBeneficiario.getPrimeiraLinha()) {
            pdf
              ...
              .fontSize(args.tamanhoDaFonte)
              .text(
                enderecoDoBeneficiario.getPrimeiraLinha(),
                args.ajusteX + 27,
                args.ajusteY + zeroUmLinha,
                {
                  lineBreak: false,
                  width: 545,
                  align: 'left',
          ...
          if (enderecoDoBeneficiario.getSegundaLinha()) {
            pdf
              ...
              .fontSize(args.tamanhoDaFonte)
              .text(
                enderecoDoBeneficiario.getSegundaLinha(),
                args.ajusteX + 27,
                args.ajusteY + zeroDoisLinha,
                {
                  lineBreak: false,
                  width: 545,
                  align: 'left',
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonteDoTitulo)
          .text(
            titulos.nomeDoPagador,
            args.ajusteX + 32,
            args.ajusteY + tituloDaPrimeiraLinha,
            {
              lineBreak: false,
              width: 294,
              align: 'left',
        ...
        if (banco.exibirReciboDoPagadorCompleto()) {
          pdf
            ...
            .text(
              titulos.carteira,
              args.ajusteX + 32,
              args.ajusteY + tituloDaPrimeiraLinhaOpcional,
              {
                lineBreak: false,
                width: 294,
                align: 'left',
          ...
          pdf
            ...
            .text(
              StringUtils.pad(
                boleto.getNumeroDoDocumentoFormatado(boleto),
                8,
                '0'
              ),
              args.ajusteX + 181,
        ...
        pdf
          ...
          .text(
            ...
            args.ajusteX + 32,
            args.ajusteY + tituloDaSegundaLinha,
            {
              lineBreak: false,
              width: 294,
              align: 'left',
  ...
  GeradorDeBoleto.prototype.gerarLinhaDigitavel = function () {
    return new Promise((resolve) => {
      ...
      boletos.forEach((boleto, indice) => {
        ...
        const linha = GeradorDeLinhaDigitavel(
