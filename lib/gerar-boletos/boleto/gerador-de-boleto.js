...
var GeradorDeBoleto = (function () {
  ...
  GeradorDeBoleto.prototype.gerarPDF = function (args) {
    return new Promise((resolve) => {
      ...
      const passOptions = args.isSystemInteract
        ? {
      ...
      pdf.registerFont('normal', args.isSystemInteract ? arial : timesNewRoman);
      pdf.registerFont(
        'negrito',
        args.isSystemInteract ? arialNegrito : timesNewRomanNegrito
      );
      pdf.registerFont(
        'italico',
        args.isSystemInteract ? arialItalico : timesNewRomanItalico
      );
      pdf.registerFont(
        'negrito-italico',
        args.isSystemInteract
          ? arialNegritoItalico
      ...
      if (args.isSystemInteract) {
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            'Saldo total atualizado da(s) dívida(s) vencida(s): R$ 738,22',
            args.ajusteX + 27,
            null,
            {
              lineBreak: false,
        ...
        pdf
          ...
          .fontSize(args.tamanhoDaFonte)
          .text(
            `Plano: ( ) Em ${'03'} parcelas de ${boleto.getValorFormatadoBRL()}`,
            args.ajusteX + 27,
            null,
            {
              lineBreak: false,
