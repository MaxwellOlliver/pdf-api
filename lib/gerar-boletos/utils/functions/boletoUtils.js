...
module.exports.especiesDeDocumento = {
  ...
  LC: 'Letra de Câmbio',
  CPS:
    'Conta de Prestação de Serviços de Profissional Liberal ou Declaração do Profissional',
...
var Datas = (function () {
  ...
  Datas.prototype.comDocumento = function (_documento, locate = 'usa') {
    if (locate === 'usa') {
      ...
      _documento = addHours(new Date(_documento), 3)
    }
  ...
  Datas.prototype.comProcessamento = function (_processamento, locate = 'usa') {
    if (locate === 'usa') {
      ...
      _processamento = addHours(new Date(_processamento ), 3)
    }
  ...
  Datas.prototype.comVencimento = function (_vencimento, locate = 'usa') {
    if (locate == 'usa') {
      ...
      _vencimento = addHours(new Date(_vencimento), 3)
    }
...
var Boleto = (function () {
  ...
  Boleto.prototype.getLinhaDigitavelFormatado = function () {
    ...
    const linha = GeradorDeLinhaDigitavel(
      this._banco.geraCodigoDeBarrasPara(this),
      this._banco
    )
